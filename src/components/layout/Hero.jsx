    ...
    const animate = () => {
      ...
      particles.forEach((particle, index) => {
        ...
        particles.slice(index + 1).forEach((otherParticle) => {
          ...
          if (distance < 150) {
            ctx.strokeStyle = `rgba(96, 239, 255, ${
              0.1 * (1 - distance / 150)
            })`;
      ...
      <div className="hero-content">
        ...
        <div className="hero-text">
          ...
          <p className="hero-description">
            Full Stack Developer specializing in MERN stack, building scalable
            and user-friendly web applications with clean architecture.
          </p>

          <p className="hero-description">
            Strong foundation in backend development, API design, authentication
            (JWT), database optimization, and system performance.
          </p>

          <p className="hero-description secondary-description">
            Passionate about writing efficient code, solving real-world
